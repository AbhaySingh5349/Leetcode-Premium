Question Link: https://leetcode.com/problems/all-the-pairs-with-the-maximum-number-of-common-followers/?envType=study-plan&id=sql-iii
...
Since the maximum number of common followers between any two users is 3, we return all pairs of users with three common followers, 
...
FROM cte
WHERE common IN (SELECT MAX(common) FROM cte)
