...
The table contains information about the login and logout dates of Leetflex accounts. It also contains IP address from which the account was logged in and out.
...
WHERE NOT (a.login > b.logout OR b.login > a.logout)
