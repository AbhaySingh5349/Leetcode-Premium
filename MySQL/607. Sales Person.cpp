...
Each row of this table contains information about one order. This includes the ID of the company, the ID of the salesperson, the date of the order
and the amount paid.
...
SELECT s.name FROM SalesPerson s
              WHERE (s.sales_id NOT IN(SELECT o.sales_id FROM 
                                                         Orders o
                                                         LEFT JOIN Company c
                                                         ON (o.com_id = c.com_id)
                                                         WHERE (c.name = 'RED')
